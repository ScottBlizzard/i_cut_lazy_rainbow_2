...
- Preflight: `/workspace/thymic_project/paper/iclr_2/outputs/mathlib430_trace_corpus_preflight_fold1_500.json`
- Output JSONL: `/workspace/thymic_project/paper/iclr_2/outputs/mathlib430_clean_trace_subset_fold1_500.jsonl`
- Input goals: 500
- Clean goals: 483
- Dropped goals: 17
...
| Reason | Count |
|---|---:|
| `missing_theorem_in_mathlib430` | 10 |
| `missing_file_in_mathlib430` | 7 |
