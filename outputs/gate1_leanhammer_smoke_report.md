...
|---|---|---|---:|---:|---|---:|
| `prop_chain3` | `complete` | `p_A, p_A_to_B, p_B_to_C` | true | true | `proved` | 3.53s |
| `prop_chain3` | `missing_bridge` | `p_A, p_A_to_B` | false | false | `search_fail` | 3.46s |
| `prop_chain3` | `wrong_direction` | `p_A, distractor_AB, p_B_to_C` | false | false | `search_fail` | 3.44s |
| `prop_chain3` | `extra_noise` | `p_A, p_A_to_B, p_B_to_C, distractor_AB` | true | true | `proved` | 3.52s |
| `prop_conjunction` | `complete` | `p_P, p_Q` | true | true | `proved` | 3.52s |
| `prop_conjunction` | `missing_right` | `p_P` | false | false | `search_fail` | 3.53s |
| `prop_conjunction` | `missing_left` | `p_Q` | false | false | `search_fail` | 3.44s |
| `prop_conjunction` | `extra_noise` | `p_P, p_Q, p_Q_to_P` | true | true | `proved` | 3.56s |
