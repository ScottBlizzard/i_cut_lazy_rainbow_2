...
- Second-stage dropped an expansion-selected core premise: 3
...
| `replay_verified_both_fail` | 15 |

### Reasons

| Reason | Count |
|---|---:|
| `failure_conditioned_rank_miss` | 15 |
| `second_stage_dropped_expansion_core` | 3 |
...
| Failure type | Count |
|---|---:|
| `imported_premise_missing` | 17 |

### Missed-Core Rank Stats

| Rank source | Count | Median | Min | Max | Top64 | Top96 |
|---|---:|---:|---:|---:|---:|---:|
| `best second-stage` | 19 | 117.0 | 94 | 207 | 0 | 2 |
| `learned` | 19 | 125.0 | 77 | 209 | 0 | 3 |
| `base` | 19 | 119.0 | 9 | 254 | 7 | 9 |
...
- `ENNReal.tendsto_nhds_of_Icc` (fallback_over_second_stage, `fallback_bridge_over_second_stage`)
...
- `LightCondensed.free_lightProfinite_internallyProjective_iff_tensor_condition'` (both_fail, `replay_verified_both_fail`)
  - reasons: `failure_conditioned_rank_miss`
  - core: 9/10 selected by second-stage; 9/10 by fallback; 9/10 by expansion
  - failure types: `imported_premise_missing`
  - missed `CategoryTheory.Functor.map_comp_assoc`: learned_rank=106, base_rank=204, second_stage_ranks=imported_premise_missing:113, fallback=False, expansion=False, same_file=False, kind=lemma
- `Matrix.J_transpose` (both_fail, `replay_verified_both_fail`)
  - reasons: `failure_conditioned_rank_miss`
  - core: 5/6 selected by second-stage; 5/6 by fallback; 5/6 by expansion
  - failure types: `imported_premise_missing`
  - missed `Matrix.fromBlocks_transpose`: learned_rank=153, base_rank=150, second_stage_ranks=imported_premise_missing:160, fallback=False, expansion=False, same_file=False, kind=theorem
- `DiscreteUniformity.eq_pure_of_cauchy` (both_fail, `replay_verified_both_fail`)
...
- `SchwartzMap.lineDerivOp_fourier_eq` (both_fail, `replay_verified_both_fail`)
  - reasons: `second_stage_dropped_expansion_core`, `failure_conditioned_rank_miss`
  - core: 8/10 selected by second-stage; 8/10 by fallback; 9/10 by expansion
  - failure types: `imported_premise_missing`
  - missed `ContinuousLinearMap.hasTemperateGrowth`: learned_rank=92, base_rank=233, second_stage_ranks=imported_premise_missing:105, fallback=False, expansion=True, same_file=False, kind=lemma
  - missed `SchwartzMap.fourier_evalCLM_eq`: learned_rank=107, base_rank=43, second_stage_ranks=imported_premise_missing:108, fallback=False, expansion=False, same_file=True, kind=theorem
- `AffineSpace.StarConvex.smul_vadd_mem_of_isClosed_of_mem_asymptoticCone` (both_fail, `replay_verified_both_fail`)
  - reasons: `failure_conditioned_rank_miss`
  - core: 14/15 selected by second-stage; 13/15 by fallback; 14/15 by expansion
  - failure types: `imported_premise_missing`
  - missed `Filter.Tendsto.frequently`: learned_rank=98, base_rank=245, second_stage_ranks=imported_premise_missing:117, fallback=False, expansion=False, same_file=False, kind=theorem
- `Finset.max'_singleton` (both_fail, `replay_verified_both_fail`)
  - reasons: `failure_conditioned_rank_miss`
  - core: 2/3 selected by second-stage; 2/3 by fallback; 2/3 by expansion
  - failure types: `imported_premise_missing`
  - missed `Finset.singleton_nonempty`: learned_rank=184, base_rank=46, second_stage_ranks=imported_premise_missing:160, fallback=False, expansion=False, same_file=False, kind=theorem
- `SimpleGraph.Walk.isHamiltonianCycle_iff_isCycle_and_length_eq` (both_fail, `replay_verified_both_fail`)
  - reasons: `failure_conditioned_rank_miss`
  - core: 3/4 selected by second-stage; 3/4 by fallback; 3/4 by expansion
  - failure types: `imported_premise_missing`
  - missed `SimpleGraph.Walk.IsCycle.not_nil`: learned_rank=126, base_rank=78, second_stage_ranks=imported_premise_missing:121, fallback=False, expansion=False, same_file=False, kind=lemma
...
- `Finset.sup'_product_right` (both_fail, `replay_verified_both_fail`)
  - reasons: `failure_conditioned_rank_miss`
  - core: 4/5 selected by second-stage; 4/5 by fallback; 3/5 by expansion
  - failure types: `imported_premise_missing`
  - missed `Finset.sup'_comm`: learned_rank=141, base_rank=42, second_stage_ranks=imported_premise_missing:138, fallback=False, expansion=False, same_file=False, kind=theorem
