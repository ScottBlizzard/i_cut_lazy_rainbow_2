...
- Second-stage gains over expansion supported by replay: 27
- Replay-verified goals missed by second-stage trace-core: 10
- Second-stage trace-core successes blocked by replay failure: 24
...
| `rule_far_learned_second_stage_final_base_guardrail_8` | 100 | 73.0% | 49.0% | 10 | 79.4 |
...
- `CharTwo.add_self_eq_zero` (second_stage_over_fallback)

## Key Negative Cases

### Replay verified, but second-stage trace-core failed

- `DiscreteUniformity.eq_pure_of_cauchy` (second_stage_over_fallback), fallback_solved=False, expansion_solved=True
...
- `ENNReal.tendsto_nhds_of_Icc` (fallback_fill), fallback_solved=True, expansion_solved=True
...
- `PowerSeries.le_weightedOrder_subst` (second_stage_over_expansion): `replay_other_lean_error`; /workspace/thymic_project/paper/iclr_2/outputs/phase3_bridge_replay_files_100/PowerSeries__le_weightedOrder_subst.lean:334:2: error: Tactic `delta` failed: did not delta reduce [PowerSeries.coeff] R : Type u_2 inst✝² : CommRing R τ : Typ...
