...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/result_ladder.pdf}
\vspace{-0.7em}
...
Rule FAR, no core tags & \best{95.7\%} & \best{89.7\%} & 45.1 \\
\bottomrule
\end{tabular}
\end{table}
...
Rule FAR + BM25 & \best{12.2\%} & \best{8.7\%} & 92.2 \\
Rule FAR full {\small (oracle ref.)} & 55.7\% & 55.2\% & 86.6 \\
\bottomrule
\end{tabular}
\end{table}
